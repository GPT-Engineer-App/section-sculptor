...
const IntegrationsSection = () => {
  return (
    <section className="bg-gray-200 py-40 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <div className="grid grid-cols-2 gap-4">
              {[...Array(8)].map((_, index) => (
                <div key={index} className="bg-black rounded-full p-3 flex items-center justify-center w-24 h-12 transform my-6 rotate-90 shadow-md">
                  {index % 3 === 0 ? (
                    <img
                      src="/favicon.ico"
                      alt="Veloxforce icon"
